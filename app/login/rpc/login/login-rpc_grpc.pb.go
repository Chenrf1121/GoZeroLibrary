...
func (c *loginClient) Login(ctx context.Context, in *IdReq, opts ...grpc.CallOption) (*IdResp, error) {
	out := new(IdResp)
...
type LoginServer interface {
	Login(context.Context, *IdReq) (*IdResp, error)
...
func (UnimplementedLoginServer) Login(context.Context, *IdReq) (*IdResp, error) {
...
func _Login_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServer).Login(ctx, req.(*IdReq))
	}
